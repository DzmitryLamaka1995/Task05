...
public class TabletPC extends ApplianceWithoutMains{
	...
	private static final long serialVersionUID = 4693826792825861561L;
	...
	public TabletPC(String manufacturer,double batteryCapacity, double displayInches, int memoryRom, int flashMemoryCapacity,
			String color) {
