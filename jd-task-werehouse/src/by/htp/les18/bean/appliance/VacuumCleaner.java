...
public class VacuumCleaner extends OtherAppliance {
	...
	private static final long serialVersionUID = 7843232285770577776L;
	...
	public VacuumCleaner(String manufacturer, int powerConsumption, String filterType, String bagType, String wandType, int motorSpeedRegulation,
			int cleaningWidth) {
