...
public class Oven extends AppliaceForFood{
	...
	private static final long serialVersionUID = 3063474426338050479L;
	...
	public Oven(String manufacturer,int powerConsumption, double weight,int capacity, double depth, double height, double width) {
